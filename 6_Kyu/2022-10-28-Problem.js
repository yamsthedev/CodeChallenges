// 6 Kyu Problem - October 28th 2022
// Buying a car
// Math, Math.round()
...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
    ...
    if(startPriceOld === startPriceNew) return [monthsSaved, moneyLeft]
    
    while(startPriceOld + savingperMonth * monthsSaved <= startPriceNew){
      if(monthsSaved % 2 !== 0){
    ...
    moneyLeft = (startPriceOld + savingperMonth * monthsSaved) - startPriceNew
    
    return [monthsSaved, Math.round(moneyLeft)]
  }
